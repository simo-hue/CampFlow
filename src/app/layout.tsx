...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'it_IT',
    url: 'https://campflow.app', // Placeholder URL, user can update later or usage variable
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="https://github.com/simo-hue/CampFlow" className="text-sm font-medium hover:text-primary transition-colors">
              Contatti
            </Link>
            <Link href="https://github.com/simo-hue/CampFlow">
          ...
          <Sheet>
            ...
            <SheetContent side="right">
              <div className="flex flex-col gap-4 mt-8">
                ...
                <Link href="https://github.com/simo-hue/CampFlow" className="text-lg font-medium">Contatti</Link>
