...
import { DemographicsChart } from "@/components/stats/DemographicsChart";
import {
    Euro,
    Users,
    CalendarDays,
...
export default function StatsPage() {
    ...
    if (error) {
        return <div className="p-8 text-red-500">Errore nel caricamento delle statistiche.</div>;
    }
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                        ...
                        <div className="col-span-3">
                            <DemographicsChart data={stats.charts.nationalityDistribution} />
                        </div>
                    </div>
