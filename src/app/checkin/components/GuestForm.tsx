    ...
    return (
        <div className={cn(
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 bg-muted/20 p-3 rounded-lg border border-border/50">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="Italia"
                            className={cn("h-9", errors.birth_country && "border-destructive")}
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        {isItaly(guest.birth_country) ? (
                            <ProvinceAutocomplete
                                ...
                                placeholder="RM"
                                className={cn("h-9", errors.birth_province && "border-destructive")}
                            />
                        ) : (
                            <Input
                                value={guest.birth_province}
                                ...
                                placeholder="--"
                                className={cn("h-9 uppercase", errors.birth_province && "border-destructive")}
                            />
                        )}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        {isItaly(guest.birth_country) ? (
                            <MunicipalityAutocomplete
                                ...
                                className={cn("h-9", errors.birth_city && "border-destructive")}
                            />
                        ) : (
                            <Input
                                value={guest.birth_city}
                ...
                <div className="mt-8 animate-in slide-in-from-top-4 duration-300">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 text-green-700 dark:text-green-500 font-semibold border-b pb-2">
                            ...
                            <div className="space-y-3">
                                <div className="space-y-1">
                                    <Label className={cn("text-xs", errors.address && "text-destructive")}>Indirizzo</Label>
                                    <Input
                                        value={guest.address || ''}
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.residence_city && "text-destructive")}>Comune</Label>
                                        <Input
                                            value={guest.residence_city || ''}
                                            onChange={e => handleChange('residence_city', e.target.value)}
                                            className={cn(errors.residence_city && "border-destructive")}
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.residence_zip && "text-destructive")}>CAP</Label>
                                        <Input
                                            value={guest.residence_zip || ''}
                                            onChange={e => handleChange('residence_zip', e.target.value)}
                                            className={cn(errors.residence_zip && "border-destructive")}
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.residence_province && "text-destructive")}>Provincia</Label>
                                        <Input
                                            value={guest.residence_province || ''}
                                            onChange={e => handleChange('residence_province', e.target.value)}
                                            className={cn(errors.residence_province && "border-destructive")}
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.residence_country && "text-destructive")}>Stato</Label>
                                        <Input
                                            value={guest.residence_country || ''}
                                            onChange={e => handleChange('residence_country', e.target.value)}
                                            className={cn(errors.residence_country && "border-destructive")}
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* Documento */}
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 text-amber-700 dark:text-amber-500 font-semibold border-b pb-2">
                            ...
                            <div className="space-y-3">
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.document_type && "text-destructive")}>Tipo</Label>
                                        <select
                                            className={cn(
                                                "flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
                                    ...
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.document_number && "text-destructive")}>Numero</Label>
                                        <Input
                                            value={guest.document_number || ''}
                                            onChange={e => handleChange('document_number', e.target.value)}
                                            className={cn(errors.document_number && "border-destructive")}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.document_issuer && "text-destructive")}>Ente</Label>
                                        <Input
                                            value={guest.document_issuer || ''}
                                            onChange={e => handleChange('document_issuer', e.target.value)}
                                            className={cn(errors.document_issuer && "border-destructive")}
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.document_issue_date && "text-destructive")}>Data Rilascio</Label>
                                        <Input
                                            type="date"
                                            value={guest.document_issue_date || ''}
                                            onChange={e => handleChange('document_issue_date', e.target.value)}
                                            className={cn(errors.document_issue_date && "border-destructive")}
                                        />
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.document_issue_city && "text-destructive")}>Comune Ril.</Label>
                                        <Input
                                            value={guest.document_issue_city || ''}
                                            onChange={e => handleChange('document_issue_city', e.target.value)}
                                            className={cn(errors.document_issue_city && "border-destructive")}
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <Label className={cn("text-xs", errors.document_issue_country && "text-destructive")}>Stato Ril.</Label>
                                        <Input
                                            value={guest.document_issue_country || ''}
                                            onChange={e => handleChange('document_issue_country', e.target.value)}
                                            className={cn(errors.document_issue_country && "border-destructive")}
                                        />
                                    </div>
                                </div>
                            </div>
